...
public class JogadorController : MonoBehaviour
{
    ...
    [SerializeField] // Se esta se movendo
    ...
    [SerializeField] // Se esta correndo
    ...
    public void OnMove(InputAction.CallbackContext context)
    {
        ...
        if(IsAlive) // Só pode se mover se estiver vivo
        {
    ...
    {   // Se apertou o botao de correr, continua até parar de apertar o botão
        if(context.started)
        {   
            IsRunning = true;
        }
